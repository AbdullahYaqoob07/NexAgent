              ...
              appearance={{
                elements: {
                  ...
                  socialButtonsBlockButton: 
                    "flex items-center justify-center gap-3 bg-white/50 hover:bg-white/20 text-white border border-white hover:border-[#FF6900]/50 font-medium py-3 px-6 rounded-xl transition-all duration-300 w-full group shadow-lg min-h-[48px]",
