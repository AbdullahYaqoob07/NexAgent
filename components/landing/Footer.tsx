  ...
  return (
    <footer className="relative border-t border-white/10 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-96 h-96 bg-[#ff6b35]/5 rounded-full blur-3xl" />
      </div>
            ...
            <div className="lg:col-span-2">
              ...
              >
                <div className="flex items-center gap-2">
                  <div className="w-10 h-10 bg-gradient-to-br from-[#ff6b35] to-[#ff8555] rounded-xl flex items-center justify-center">
                  ...
                  {socialLinks.map((link, index) => {
                    ...
                    return (
                      <motion.a
                        ...
                        className="w-10 h-10 glass-card rounded-lg flex items-center justify-center text-white/60 hover:text-white hover:bg-[#ff6b35]/20 transition-all duration-300 hover-lift"
                  ...
                  <ul className="space-y-4">
                    {section.links.map((link, linkIndex) => (
                      <li key={linkIndex}>
                        <a
                          href={link.href}
                          className="text-white/60 hover:text-[#ff6b35] transition-colors duration-300 text-sm"
                        >
                          {link.name}
                        </a>
                      </li>
